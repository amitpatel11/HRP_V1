...
var hrpApp=angular.module('hrpApp',['ui.router','ngResource', 'ngMaterial', 'ngMessages','ui.bootstrap','ngCookies']);
...
hrpApp.config(['$stateProvider', '$urlRouterProvider', function($stateProvider, $urlRouterProvider){
    ...
    $stateProvider
            ...
            .state('register', {//nested state [registration is the nested state of register state]
             ...
             .state('serviceDetails', {//nested state [Dashboard is the nested state of login state]
                url: "/serviceDetails",
                templateUrl: "views/service/ServiceDetails.html",
